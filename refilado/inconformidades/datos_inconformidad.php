<?php 
  ...
  $registrosImpFilas = sqlsrv_query($connPlas, $comprobacionRefi, array(), array( "Scrollable" => 'static' ));
  ...
  if ($contImpFilas != 0){
      ...
      echo    "<form method='post' action='http://".$_SERVER['SERVER_NAME']."/apps/refilado/inconformidades/nueva_inconformidad.php'>
