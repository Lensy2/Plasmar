<?php 
  ...
  $registrosImpFilas = sqlsrv_query($connPlas, $comprobacionSell, array(), array( "Scrollable" => 'static' ));
  ...
  if ($contImpFilas != 0){
      ...
      echo    "<form method='post' action='http://".$_SERVER['SERVER_NAME']."/apps/sellado/inconformidades/nueva_inconformidad.php'>
