      ...
      <div class="content-wrapper">
        ...
        <br>
           ...
           <!--- Detalles Orden de Produccion Laminacion -->
            ...
            <div class="row">
                    <div class="col-md-4">
                        <h4 align="center">ANCHO (cms)<input type="checkbox" class="chkplas" class="minimal" value="chk_ancho" <?php if(in_array('chk_ancho',$sellado)){echo 'checked="checked"';}?> name="chksellado[]" ></h4>
                            <div class="table-responsive"> 
                                <table class="table table-bordered"> 
                                    <thead> 
                                        <tr> 
                    ...
                    <div class="col-md-4">
                        <h4 align="center">CALIBRE (mp)<input type="checkbox" class="chkplas" class="minimal" value="chk_calibre" <?php if(in_array('chk_calibre',$sellado)){echo 'checked="checked"';}?> name="chksellado[]" ></h4>
                            <div class="table-responsive"> 
                                <table class="table table-bordered"> 
                                    <thead> 
                                        <tr> 
              ...
              <div class="col-md-12">
                   <div class="table-responsive"> 
                      ...
                      <tr>
                            ...
                            <td><input type="date" min=2014-01-01 class="form-control" value="<?php echo date_format($datos['fechase'],'Y-m-d') ?>"  name="fechrefi">   </td>
                            <td><?php?></td>
