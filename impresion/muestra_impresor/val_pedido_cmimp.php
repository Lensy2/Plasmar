<?php 
  ...
  $validarCMImp = sqlsrv_query($connSCPBD, $contadorCMImp);
  $fila = sqlsrv_fetch_object($validarCMImp);
...
if ($fila->Total == 0){
  if ($contImpFilas != 0){
      ...
      echo    "<form method='get' action='http://".$_SERVER['SERVER_NAME']."/apps/impresion/muestra_impresor/control_muestra_imp.php'>
