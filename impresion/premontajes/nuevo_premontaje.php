        ...
        <section class="content">
          ...
          <div class="box">            
            <div class="box-header">
                  <h3 class="box-title"><i class="fa fa-fw fa-plus-circle"></i>Nuevo - Control De Premontaje</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
          
            
            <form action="procesar_premontaje.php" method="post" accept-charset="utf-8">
			    ...
			    <!--- Detalles Orden de Produccion Extrusion -->
						...
						<br>
						        ...
						        <div class="table-responsive"> 
						            ...
						            <thead>
						              <tr>
						               	<th>IMPRESORA N°<input type="checkbox" class="chkplas" class="minimal" value="chk_impresora" name="chkPremontaje[]" ></th>
						               	<th>Kg PEDIDOS</th>
									    <th>PRESENTACION<input type="checkbox" class="chkplas" class="minimal" value="chk_presentacion" name="chkPremontaje[]" ></th>
									    <th>ANCHO<input type="checkbox" class="chkplas" class="minimal" value="chk_ancho" name="chkPremontaje[]" ></th>
									    <th>TIPO IMPRESION<input type="checkbox" class="chkplas" class="minimal" value="chk_tipoimp" name="chkPremontaje[]" ></th>
									    <th>MONTAJE </th>
									   </tr>
						              </thead>
						              <tbody> 
			                ...
			                <h4 align="center"></h4>
			                    <div class="table-responsive"> 
			                        <table class="table table-bordered"> 
			                            <thead> 
			                                <tr> 
			                                    <th>RODILLO<input type="checkbox" class="chkplas" class="minimal" value="chk_rodillo" name="chkPremontaje[]" ></th> 
			                                    <th>PIÑON<input type="checkbox" class="chkplas" class="minimal" value="chk_pinon" name="chkPremontaje[]" ></th> 
			                                </tr> 
			                            </thead> 
			                            <tbody> 
			                                <tr>    
			...
			<!--- Espsificaciones Orden de Produccion Impresion -->
				    ...
				    <br>
				            ...
				            <div class="col-md-4">
				                <h4 align="center">Ancho (cms)<input type="checkbox" class="chkplas" class="minimal" value="chk_fancho" name="chkPremontaje[]" ></h4>
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 
				            ...
				            <div class="col-md-4">
				                <h4 align="center">LARGO (cms)<input type="checkbox" class="chkplas" class="minimal" value="chk_flargo" name="chkPremontaje[]" ></h4>
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 
				  ...
				  <!--- Montaje Orden de Produccion Impresion -->
				                    ...
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 				                                    
				                                    <th></th>
												    <th>TINTERO 1<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero1" name="chkPremontaje[]" ></th>
												    <th>TINTERO 2<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero2" name="chkPremontaje[]" ></th>
												    <th>TINTERO 3<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero3" name="chkPremontaje[]" ></th>
												    <th>TINTERO 4<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero4" name="chkPremontaje[]" ></th>
												  </tr>
												  <tr>
												    <th>COLOR</th>
				                    ...
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 				                                    
				                                    <th></th>
												    <th>TINTERO 5<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero5" name="chkPremontaje[]" ></th>
												    <th>TINTERO 6<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero6" name="chkPremontaje[]" ></th>
												    <th>TINTERO 7<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero7" name="chkPremontaje[]" ></th>
												    <th>TINTERO 8<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero8" name="chkPremontaje[]" ></th>
												  </tr>
												  <tr>
												    <th>COLOR</th>
				       ...
				       <div class="table-responsive"> 
	                     ...
	                     <thead> 
				         <tr>
					    	<th>MONTAJE<input type="checkbox" class="chkplas" class="minimal" value="chk_montaje" name="chkPremontaje[]" ></th>
					   	 	<th>OBSERVACIONES<input type="checkbox" class="chkplas" class="minimal" value="chk_observa" name="chkPremontaje[]" ></th>
					  	</tr>
				        ...
				        <tr>
				         ...
				         <tr>
					    	<th>OBSERVACIONES PREMONTADOR</th>
					  		  ...
					  		  <tbody> 
				                	<tr>   
						      	<td><textarea rows="4" cols="70" name="observa"></textarea></td>						      	
			                    </tr>           
				                </tbody> 
								</thead> 
				                ...
				                <h4 align="center">VERIFICACION PREMONTAJE</h4>
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            ...
				                            <tbody> 
				                                <tr>    
										      	<td><input class="form-control" type="number" step="any" name="repeticion"></td>
										      	<td><input class="form-control" type="number" step="any" name="centros"></td>
										      	<td><input class="form-control" type="number" step="any" name="rodilloz"></td>
										      </tr>           
				                            </tbody> 
				                        </table> 
				                    </div>
