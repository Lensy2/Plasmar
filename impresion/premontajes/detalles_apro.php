              ...
              <div class="row">
               ...
               <div class="col-xs-9">
                 <br>
                  ...
                  <div class="col-md-2">
                        <a class="btn btn-block btn-primary" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/impresion/premontajes/apro_premontajes.php" style="text-decoration: none;">Volver</a>
                  </div>
               </div>
            </div>
