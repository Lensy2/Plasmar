<?php 
  ...
  $validarCMMat = sqlsrv_query($connSCPBD, $contadorCMMat);
  $fila = sqlsrv_fetch_object($validarCMMat);
...
if ($fila->Total == 0){
  if ($contImpFilas != 0){
      ...
      echo    "<form method='get' action='http://".$_SERVER['SERVER_NAME']."/apps/impresion/muestra_matizador/control_muestra_mat.php'>
