<?php 
  ...
  $validarPremontajes = sqlsrv_query($connSCPBD, $contadorPremontajes);
  $fila = sqlsrv_fetch_object($validarPremontajes);
...
if ($fila->Total == 0) {   
  ...
  if ($contImpFilas != 0){
      ...
      echo    "<form method='post' action='http://".$_SERVER['SERVER_NAME']."/apps/impresion/premontajes/nuevo_premontaje.php'>
