        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header">
                  <h3 class="box-title">
                    Controles Analista De Laboratorio - Pendientes
                  </h3>
          </div><!-- /.box-header -->
            <div class="box-body">
            <?php
             $registros = sqlsrv_query($connSCPBD, $control_analista);
            ?>
...
while($fila = sqlsrv_fetch_object($registros))
{
  echo "<tr>";
    ...
    echo "<td><span class='label label-warning'>".$fila->estado_ana."</span></td>";
    echo "<td><i class='fa fa-fw fa-edit'></i><a href='editar_analista.php?pedido=$fila->num_orden'>Editar</a></td>";
