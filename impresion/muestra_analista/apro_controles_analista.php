...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Impresión
            <small>Control Analista De Laboratorio</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Impresion</a></li>
            <li class="active">Control Analista De Laboratorio</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header">
                  <h3 class="box-title">
                    Controles Muestra De Laboratrio - Aprobados
                  </h3>
          </div><!-- /.box-header -->
            <div class="box-body">
            <?php
             $registros = sqlsrv_query($connSCPBD, $control_anali_apro);
            ?>
...
while($fila = sqlsrv_fetch_object($registros))
{
  echo "<tr>";
    ...
    echo "<td><span class='label label-success'>".$fila->estado_ana."</span></td>";
     echo "<td><i class='fa fa-fw fa-plus-circle'></i><a href='#' data-toggle='modal' data-target='#modalNuevoCMsup' data-whatever='$fila->num_orden'>Nuevo - C.M Supervisor</a></td>";
    echo "<td><i class='fa fa-fw fa-eye'></i><a href='detalles_apro.php?pedido=$fila->num_orden'>Detalles</a></td>";

    //echo "<td><i class='fa fa-fw fa-edit'></i><a href='controles.php'>Nuevo Control Supervisor</a></td>";
  echo "</tr>";
}
...
<div class="modal fade" id="modalNuevoCMsup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
