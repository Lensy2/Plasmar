<?php 
  ...
  $validarCMAna = sqlsrv_query($connSCPBD, $contadorCMAna);
  $fila = sqlsrv_fetch_object($validarCMAna);
...
if ($fila->Total == 0){
  if ($contImpFilas != 0){
      ...
      echo    "<form method='get' action='http://".$_SERVER['SERVER_NAME']."/apps/impresion/muestra_analista/control_muestra_anali.php'>
