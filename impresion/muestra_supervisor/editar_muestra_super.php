              ...
              ?>
                ...
                <h3 align="center">SUPERVISOR</h3><br>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <form action="actualizar_super.php" method="post" accept-charset="utf-8">
                             ...
                             <div class="tab-content">
                                 ...
                                 $supervisor = '';
                                 $supervisor="SELECT * FROM cm_supervisor WHERE num_orden = '$pedido'"; 
                                  $leer = sqlsrv_query($connSCPBD,$supervisor);


                                  $datos = sqlsrv_fetch_array($leer);
                                  $supervisor = explode(', ', $datos['supervisor']);
                                            ...
                                            <div class="table-responsive">    
                                                <table class="table table-bordered">                                                            
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input  type="checkbox" class="chkplas"  class="minimal"  value="chk_calidad"  <?php if(in_array('chk_calidad',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>
                                                            </tr>
                                                            <tr> 
                                                            <th>TONOS</th>
                                                              <td><input  type="checkbox" class="chkplas"  class="minimal" value="chk_tonos" <?php if(in_array('chk_tonos',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>
                                                          </tr> 
                                                            <tr>
                                                            <th>IMPRESION</th>
                                                              <td><input  type="checkbox" class="chkplas"  class="minimal" value="chk_impresion" <?php if(in_array('chk_impresion',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>
                                                          </tr>
                                                          <tr>
                                                            <th>REGISTRO</th>
                                                              <td><input type="checkbox" class="chkplas" class="minimal" value="chk_registro" <?php if(in_array('chk_registro',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>                                      
                                                          </tr>
                                                          <tr>
                                                            <th>ALTURAS</th>
                                                              <td><input type="checkbox" class="chkplas" class="minimal" value="chk_alturas" <?php if(in_array('chk_alturas',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>
                                                            </tr>
                                                          <tr>
                                                            <th>SENTIDO DE EMBOBINADO</th>
                                                              <td><input type="checkbox" class="chkplas" class="minimal" value="chk_santido" <?php if(in_array('chk_santido',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>
                                                            </tr> 
                                                          <tr>
                                                            <th>PIE IMPRENTA</th>
                                                              <td><input type="checkbox" class="chkplas" class="minimal" value="chk_imprenta" <?php if(in_array('chk_imprenta',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>
                                                             
                                                          </tr>
                                                          <tr>
                                                            <th>ADHESION DE TINTA </th>
                                                              <td><input type="checkbox" class="chkplas" class="minimal" value="chk_adhesion" <?php if(in_array('chk_adhesion',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td> </tr>
                                                              <tr>
                                                            <th>ANILOX</th>
                                                              <td><input type="text" class="form-control" value="<?php echo $datos['anilox'] ?>" name="anilox"></td> 
                                                          </tr>  
                                                            <tr>
                                                            <th>VISCOCIDAD DEL BARNIZ, SI ES REFERENCIA CALOR CONSTANTE (SEGUNDOS) </th>
                                                              <td><input type="checkbox" class="chkplas" class="minimal" value="chk_visco" <?php if(in_array('chk_visco',$supervisor)){echo 'checked="checked"';}?> name="chkRequisitos[]" ></td>  
                                                          </tr>
                                                          <tr>
                                                            <th>VELOCIDAD MAQUINA</th>
                                                              <td><input type="text" class="form-control" value="<?php echo $datos['vel_maquina'] ?>" name="vel_maquina" ></td>  
                                                          </tr>                                                          
                                                            </thead> 
                                                         </table> 
                                                    </div>
                                                    ...
                                                    <div class="table-responsive"> 
                                                        ...
                                                        <th>VISCOCIDAD DEL BARNIZ Y OBSERVACIONES</th>
                                                          ...
                                                          <tbody> 
                                                            <tr>   
                                                              <td><div class="col-md-8"><textarea rows="4" cols="70" class="form-control"  name="coment4"><?php echo $datos['observa4'] ?></textarea></td>
...
<?php 
    ...
    $super_nuevoprem = "SELECT * FROM dbo.super_nuevoprem WHERE num_orden = $pedido";
    $query = sqlsrv_query($connSCPBD,$super_nuevoprem);
    $regNprem = sqlsrv_fetch_array($query); 
?>
...
<div class="tab-pane" id="tab_5">
                        ...
                        <input type="hidden" value="2" name="">
                          ...
                          <tr>
                            <th>STICK</th>
                              <td><input type="text" id="color1" class="form-control" value="<?php echo $regNprem['color1']; ?>" name="color1"><td>
                              <td><input type="text" id="color2" class="form-control" value="<?php echo $regNprem['color2']; ?>" name="color2"><td>
                              <td><input type="text" id="color3" class="form-control" value="<?php echo $regNprem['color3']; ?>" name="color3"><td>
                              <td><input type="text" id="color4" class="form-control" value="<?php echo $regNprem['color4']; ?>" name="color4"><td>
                          </tr>
                          <tr>
                            <th>ANILOX</th>
                              <td><input type="text" id="lineat1" class="form-control" value="<?php echo $regNprem['lineat1']; ?>" name="lineat1"><td>
                              <td><input type="text" id="lineat2" class="form-control" value="<?php echo $regNprem['lineat2']; ?>" name="lineat2"><td>
                              <td><input type="text" id="lineat3" class="form-control" value="<?php echo $regNprem['lineat3']; ?>" name="lineat3"><td>
                              <td><input type="text" id="lineat4" class="form-control" value="<?php echo $regNprem['lineat4']; ?>" name="lineat4"><td>
                          </tr>
                          ...
                          <tr>
                            <th>STICK</th>
                              <td><input type="text" id="color5" class="form-control" value="<?php echo $regNprem['color5']; ?>" name="color5"><td>
                              <td><input type="text" id="color6" class="form-control" value="<?php echo $regNprem['color6']; ?>" name="color6"><td>
                              <td><input type="text" id="color7" class="form-control" value="<?php echo $regNprem['color7']; ?>" name="color7"><td>
                              <td><input type="text" id="color8" class="form-control" value="<?php echo $regNprem['color8']; ?>" name="color8"><td>
                              </tr>
                          <tr>
                            <th>ANILOX</th>
                              <td><input type="text" id="lineat5" class="form-control" value="<?php echo $regNprem['lineat5']; ?>" name="lineat5"><td>
                              <td><input type="text" id="lineat6" class="form-control" value="<?php echo $regNprem['lineat6']; ?>" name="lineat6"><td>
                              <td><input type="text" id="lineat7" class="form-control" value="<?php echo $regNprem['lineat7']; ?>" name="lineat7"><td>
                              <td><input type="text" id="lineat8" class="form-control" value="<?php echo $regNprem['lineat8']; ?>" name="lineat8"><td>
                          </tr>
