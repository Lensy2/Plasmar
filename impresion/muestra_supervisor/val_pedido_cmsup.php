<?php 
  ...
  $validarCMSup = sqlsrv_query($connSCPBD, $contadorCMSup);
  $fila = sqlsrv_fetch_object($validarCMSup);
...
if ($fila->Total == 0){
  if ($contImpFilas != 0){
      ...
      echo    "<form method='get' action='http://".$_SERVER['SERVER_NAME']."/apps/impresion/muestra_supervisor/control_muestra_super.php'>
