...
while($fila = sqlsrv_fetch_object($registros))
{
  echo "<tr>";
    ...
    echo "<td><a href='ver_inconformidad.php?id=$fila->Idimp_inconformidades'>Detalle</a><i class='fa fa-fw fa-eye'></i></td>";
  echo "</tr>";
}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">      
          ...
          <div class="row">
            ...
            <div class='col-md-4'>
              <input type="number" step="any" placeholder="Ingresar Valor" class="form-control" id="recipient-name">
