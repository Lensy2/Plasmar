        ...
        <div class="box-body">
             ...
             <table class="table table-striped" >
               ...
               for($i=0; $i<$numElementosReal; $i++){
                ...
                echo "<a href='ftp://192.168.2.8/NAS_Public/SCPBD/impresion_img/$separarFotos[$i].jpg' target='blank'><img width='200px' src='ftp://192.168.2.8/NAS_Public/SCPBD/impresion_img/$separarFotos[$i].jpg' /></a>" ;
                echo "<br>";
              }      
...
include '../../includes/impresion/footer.php';
