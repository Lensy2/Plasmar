          ...
          <div class="box">            
			    ...
			    <!--- Detalles Orden de Produccion Extrusion -->
						...
						<br>
						        ...
						        <div class="table-responsive"> 
						            ...
						            <thead>
						              <tr>
						               	<th>IMPRESORA N°<input type="checkbox" class="chkplas" class="minimal" value="chk_impresora" name="chkRequisitos[]" ></th>
						               	<th>Kg PEDIDOS<input type="checkbox" class="chkplas" class="minimal" value="chk_kgpedidos" name="chkRequisitos[]" ></th>
									    <th>PRESENTACION<input type="checkbox" class="chkplas" class="minimal" value="chk_presentacion" name="chkRequisitos[]" ></th>
									    <th>ANCHO<input type="checkbox" class="chkplas" class="minimal" value="chk_ancho" name="chkRequisitos[]" ></th>
									    <th>TIPO IMPRESION<input type="checkbox" class="chkplas" class="minimal" value="chk_tipoimp" name="chkRequisitos[]" ></th>
									    <th>MONTAJE <input type="checkbox" class="chkplas" class="minimal" value="chk_montaje" name="chkRequisitos[]" ></th>
									   </tr>
						              </thead>
						              <tbody> 
						<tr>
			...
			<!--- Detalles Orden de Produccion Impresion -->
			        ...
			        <div class="table-responsive"> 
			            ...
			            <thead>
			              <tr>
			                <th>DESTINO<input type="checkbox" class="chkplas" class="minimal" value="chk_destino" name="chkRequisitos[]" ></th>
			                <th>CODIGO BARRAS</th>
			                <th>LOGO TIPO<input type="checkbox" class="chkplas" class="minimal" value="chk_logo" name="chkRequisitos[]" ></th>
			                <th>BOCA POR<input type="checkbox" class="chkplas" class="minimal" value="chk_boca" name="chkRequisitos[]" ></th>
			                <th>TIPO PEDIDO<input type="checkbox" class="chkplas" class="minimal" value="chk_tipopedido" name="chkRequisitos[]" ></th>
			              </tr>
			              </thead>
			              <tbody> 
			          <tr>
			                ...
			                <h4 align="center"></h4>
			                    <div class="table-responsive"> 
			                        <table class="table table-bordered"> 
			                            <thead> 
			                                <tr> 
			                                    <th>RODILLO<input type="checkbox" class="chkplas" class="minimal" value="chk_rodillo" name="chkRequisitos[]" ></th> 
			                                    <th>PIÑON<input type="checkbox" class="chkplas" class="minimal" value="chk_pinon" name="chkRequisitos[]" ></th> 
			                                </tr> 
			                            </thead> 
			                            <tbody> 
			                                <tr>    
				    ...
				    <div class="row">
				            <div class="col-md-12">
				                <h4 align="center">ALTURAS IMPRESION<input type="checkbox" class="chkplas" class="minimal" value="chk_alturas" name="chkRequisitos[]" ></h4>
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 
			...
			<!--- Espsificaciones Orden de Produccion Impresion -->
				    ...
				    <div class="row">
				            <div class="col-md-4">
				                <h4 align="center">Ancho (cms)<input type="checkbox" class="chkplas" class="minimal" value="chk_fancho" name="chkRequisitos[]" ></h4>
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 
				            ...
				            <div class="col-md-4">
				                <h4 align="center">LARGO (cms)<input type="checkbox" class="chkplas" class="minimal" value="chk_flargo" name="chkRequisitos[]" ></h4>
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 
				  ...
				  <!--- Montaje Orden de Produccion Impresion -->
				                    ...
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 				                                    
				                                    <th></th>
												    <th>TINTERO 1<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero1" name="chkRequisitos[]" ></th>
												    <th>TINTERO 2<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero2" name="chkRequisitos[]" ></th>
												    <th>TINTERO 3<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero3" name="chkRequisitos[]" ></th>
												    <th>TINTERO 4<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero4" name="chkRequisitos[]" ></th>
												  </tr>
												  <tr>
												    <th>COLOR</th>
				                    ...
				                    <div class="table-responsive"> 
				                        <table class="table table-bordered"> 
				                            <thead> 
				                                <tr> 				                                    
				                                    <th></th>
												    <th>TINTERO 5<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero5" name="chkRequisitos[]" ></th>
												    <th>TINTERO 6<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero6" name="chkRequisitos[]" ></th>
												    <th>TINTERO 7<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero7" name="chkRequisitos[]" ></th>
												    <th>TINTERO 8<input type="checkbox" class="chkplas" class="minimal" value="chk_tintero8" name="chkRequisitos[]" ></th>
												  </tr>
												  <tr>
												    <th>COLOR</th>
	                    ...
	                    <div class="table-responsive"> 
	                        <table class="table table-bordered"> 
	                            <thead>      
				                   <tr>
								    <th>TIPO DE TINTA<input type="checkbox" class="chkplas" class="minimal" value="chk_tipotinta" name="chkRequisitos[]" ></th>
								    <th>COLORES SEGUN<input type="checkbox" class="chkplas" class="minimal" value="chk_colores" name="chkRequisitos[]" ></th>
								    <th>TIPO MATERIAL<input type="checkbox" class="chkplas" class="minimal" value="chk_material" name="chkRequisitos[]" ></th>
								  </tr>
								  ...
								  <tr>
								    ...
								    <th>GUIA PARA FOTOCELDA<input type="checkbox" class="chkplas" class="minimal" value="chk_fotocelda" name="chkRequisitos[]" ></th>
								    <th>RAYA PARA</th>
								  </tr>
				       ...
				       <div class="table-responsive"> 
				         ...
				         <tr>
					    	<th>MONTAJE<input type="checkbox" class="chkplas" class="minimal" value="chk_montaje" name="chkRequisitos[]" ></th>
					   	 	<th>OBSERVACIONES DE CALIDAD<input type="checkbox" class="chkplas" class="minimal" value="chk_observa" name="chkRequisitos[]" ></th>
					  	</tr>
				        ...
				        <tr>
				         ...
				         <tr>
					    	<th>OBSERVACIONES PREMONTADOR<input type="checkbox" class="chkplas" class="minimal" value="chk_observa" name="chkRequisitos[]" ></th>
					  	</tr>
