...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Impresion
            <small>Nuevo Control De Requisitos</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Impresion</a></li>
            <li class="active">Nuevo Control De Requisitos</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header">
                  <h3 class="box-title">
                    Controles De Requisitos - Pendientes
                  </h3>
          </div><!-- /.box-header -->
            <div class="box-body">
            <?php
             $registros = sqlsrv_query($connSCPBD, $requisito_pen);
...
while($fila = sqlsrv_fetch_object($registros))
{
  echo "<tr>";
    ...
    echo "<td><i class='fa fa-fw fa-edit'></i><a href='../control_requisitos/editar_control_reqimp.php?id=$fila->Idrequisitoimp&pedido=$fila->num_orden'>Editar</a></td>";
