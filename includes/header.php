    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Tasks: style can be found in dropdown.less -->
                ...
                <ul class="dropdown-menu">
                  <li>
                    ...
                    <div class="slimScrollDiv" style="position: relative;overflow: hidden;width: auto;height: auto;">
                      ...
                      <li><!-- start message -->
                        <a href="http://localhost/apps/extruder/dashboard.php">
                          <h3>
              ...
              <li>
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart"></i>Informes
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if ($archivo == 'nueva_inconf_ext') {echo "class='active'";}?>>              
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/fotomulta/foto_multas.php">
                <i class="ion ion-alert-circled"></i> <span>Foto Multas</span>
              </a>
            </li>
