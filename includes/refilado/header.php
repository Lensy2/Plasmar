      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <?php 
            if(in_array('re_ds', $_SESSION['menu'])){
           ?>
           ...
           ?>
            <li <?php if ($archivo == 'control_req') {echo "class='active'";}?>>
              ...
              <ul class="treeview-menu">
               <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/refilado/control_requisito/requisitos.php"><i class="fa fa-circle-o"></i> En Proceso</a></li>

                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/refilado/control_requisito/apro_requisitos.php"><i class="fa fa-circle-o"></i> Aprobados</a></li>
            ...
            <li <?php if ($archivo == 'nueva_inconf_ext') {echo "class='active'";}?>>              
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/refilado/inconformidades/inconformidades.php">
