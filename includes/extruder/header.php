...
<script type="text/javascript">
  ...
  function calcular_promcalibre() {
      importe_total = 0
      $(".sumcalibre").each(
        function(index, value) {
          importe_total = importe_total + eval($(this).val());
          prom = importe_total/4;
        }
      );
      $("#promcal").val(prom);
  }

   function calcular_prompeso() {
      importe_total = 0
      $(".sumpeso").each(
        function(index, value) {
          importe_total = importe_total + eval($(this).val());
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <!-- Menu Dashboard -->
           <?php 
            if(in_array('ex_ds', $_SESSION['menu'])){
           ?>
            ...
            <!-- Menu Programacion -->
            <?php 
            if(in_array('ex_pg', $_SESSION['menu'])){
            ?>
            <li <?php if ($archivo == 'programacion') {echo "class='active'";}?> >
              ...
              <ul class="treeview-menu">
                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/programacion_ad.php"><i class="fa fa-circle-o"></i> Alta Densidad</a></li>
                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/programacion_bd.php"><i class="fa fa-circle-o"></i> Baja Densidad</a></li>
              </ul>
            </li>
             <?php } ?>

            <!-- Menu Control Mezclas-->
            <?php 
            if(in_array('ex_cm', $_SESSION['menu'])){
            ?>
            <li <?php if ($archivo == 'nuevo_control_mez') {echo "class='active'";}?>>
              <a href="#">
                <i class="ion ion-funnel"></i> <span>Control de Mezclas</span><i class="fa fa-angle-left pull-right"></i>
              </a>
               <ul class="treeview-menu">
               <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/control_mezclas/controles_mezclas.php"><i class="fa fa-circle-o"></i> En Proceso</a></li>
                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/control_mezclas/apro_controles_mezclas.php"><i class="fa fa-circle-o"></i> Aprobados</a></li>                
              </ul>
            </li>
            <?php } ?>
            ...
            ?>
            <li <?php if ($archivo == 'nuevo_control_req') {echo "class='active'";}?>>
              <a href="#">
                <i class="ion ion-document-text"></i> <span>Control de Requisitos</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
               <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/control_requisitos/controles_requisitos.php"><i class="fa fa-circle-o"></i> En Proceso</a></li>
                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/control_requisitos/apro_controles_requisitos.php"><i class="fa fa-circle-o"></i> Aprobados</a></li>
            ...
            ?>
            <li <?php if ($archivo == 'nuevo_control_cal') {echo "class='active'";}?>>
              <a href="#">
                <i class="ion ion-checkmark-circled"></i> <span>Controles de Calidad</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li>
                  <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/controles_calidad/controles_calidad.php"><i class="fa fa-circle-o"></i> En Proceso</a>
                </li>
                <li>
                  <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/controles_calidad/term_controles_calidad.php"><i class="fa fa-circle-o"></i> Terminados</a>
                </li>                
              </ul>
            </li>
            <?php } ?>
            ...
            <?php 
            if(in_array('ex_inc', $_SESSION['menu'])){
            ?>
            <li <?php if ($archivo == 'nueva_inconf_ext') {echo "class='active'";}?>>              
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/inconformidades/inconformidades.php">
