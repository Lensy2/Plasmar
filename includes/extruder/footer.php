<footer class="main-footer">
    ...
    <script src="<?php echo $enlace;?>/dist/js/extruder/validacion_extruder.js"></script>
    <script src="<?php echo $enlace;?>/dist/js/autocom_operarios.js"></script>
    <script src="<?php echo $enlace;?>/dist/js/autocom_mezclas.js"></script>
    <script src="<?php echo $enlace;?>/dist/js/autocom_causas.js"></script>
    <script src="<?php echo $enlace;?>/dist/js/extruder/main_extruder.js"></script>
  </body>
</html>