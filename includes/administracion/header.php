      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <?php 
            if(in_array('cf_ds', $_SESSION['menu'])){
           ?>
            <li <?php if ($archivo == 'dashboard') {echo "class='active'";}?> >
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/administracion/dashboard.php">
           ...
           ?>
            <li <?php if ($archivo == 'usuarios') {echo "class='active'";}?>>
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/administracion/usuarios.php">
