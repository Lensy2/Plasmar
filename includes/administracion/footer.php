<footer class="main-footer">
    ...
    <script src="<?php echo $enlace;?>/dist/js/administracion/validacion_administracion.js"></script>
    <script src="<?php echo $enlace;?>/dist/js/autocom_operarios.js"></script>
    <script src="<?php echo $enlace;?>/dist/js/administracion/main_administracion.js"></script>
