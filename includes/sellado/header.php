      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <?php 
            if(in_array('se_ds', $_SESSION['menu'])){
           ?>
            ...
            ?>
            <?php 
            if(in_array('se_cr', $_SESSION['menu'])){
           ?>
            <li <?php if ($archivo == 'control_req') {echo "class='active'";}?>>
              ...
              <ul class="treeview-menu">
               <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/sellado/control_requisitos/requisitos.php"><i class="fa fa-circle-o"></i> En Proceso</a></li>

                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/sellado/control_requisitos/apro_requisitos.php"><i class="fa fa-circle-o"></i> Aprobados</a></li>
            ...
            <?php 
            if(in_array('se_inc', $_SESSION['menu'])){
            ?>
            <li <?php if ($archivo == 'nueva_inconf_ext') {echo "class='active'";}?>>              
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/sellado/inconformidades/inconformidades.php">
