      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <!-- Menu Laminacion Dashboard-->
            <?php 
            if(in_array('la_ds', $_SESSION['menu'])){
            ?>
            ...
            <!-- Menu Laminacion Controles de requisitos-->
            <?php 
            ...
            <li <?php if ($archivo == 'control_req') {echo "class='active'";}?>>
              ...
              <ul class="treeview-menu">
               <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/laminacion/control_requisitos/requisitos.php"><i class="fa fa-circle-o"></i> En Proceso</a></li>

                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/laminacion/control_requisitos/apro_requisitos.php"><i class="fa fa-circle-o"></i> Aprobados</a></li>
                
              </ul>
            </li>
            <?php } ?>    

             <!-- Menu Laminacion Inconformidades-->
            <?php 
            if(in_array('la_inc', $_SESSION['menu'])){
            ?>
            <li <?php if ($archivo == 'nueva_inconf_ext') {echo "class='active'";}?>>              
              <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/laminacion/inconformidades/inconformidades.php">
