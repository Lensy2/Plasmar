...
<table class="tg">
  ...
  ';
    ...
    <td style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;">'.$fila->tipo_proceso.'</td>
  </tr>
        ';  
            }  
            $output .= '</table>';  
            ...
            header("Content-Disposition: attachment; filename=export_procesos.xls");  
            echo $output;  
