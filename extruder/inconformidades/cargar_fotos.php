...
for($i = 0; $i < $Imagenes; $i++) {
	...
	$ImagenesSubidas[$i]="<img  height='120px'  src='ftp://192.168.2.8/NAS_Public/SCPBD/extruder_img/$nombreArchivo' class='file-preview-image'>";
}
