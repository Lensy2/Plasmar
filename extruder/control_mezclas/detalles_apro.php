                    ...
                    <h4 align="center"><b>Control de Mezclas</b></h4>
                        ...
                        <!--- Fin Velocidades y Mezclas Orden de Produccion Extrusion -->
                            ...
                            <div class="row">                              
                                    ...
                                    <div class="col-md-2">
                                        <a class="btn btn-block btn-primary" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/apps/extruder/control_mezclas/apro_controles_mezclas.php" style="text-decoration: none;">Volver</a>
                                    </div>
                                </div>
                            </div>
                        </form>                 
