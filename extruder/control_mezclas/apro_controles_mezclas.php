        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header">
                  <h3 class="box-title">
                    Controles de Mezclas - Aprobados
                  </h3>
          </div><!-- /.box-header -->
            <div class="box-body">
            <?php              
              $registros = sqlsrv_query($connSCPBD, $control_mezclas_apro);
            ?>
...
while($fila = sqlsrv_fetch_object($registros))
{
  echo "<tr>";
    ...
    echo "<td><i class='fa fa-fw fa-plus-circle'></i><a href='#'' data-toggle='modal' data-target='#modalNuevoCR' data-whatever='$fila->num_orden' data-tipopedido='$fila->tipo_ext' data-idmezcla='$fila->num_mezcla'>Nuevo Control de Requisito</a></td>";
...
<!-- ========== ventanas modales en controles de mezclas ========== -->
  ...
  <div class="modal fade" id="modalNuevoCR" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="exampleModalLabel" style="text-align: center;"><i class="fa fa-fw fa-warning"></i>¡Validacion del pedido!</h4>
        </div>
