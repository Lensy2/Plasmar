            ...
            <div class="box-body">                       
              ...
              <!--- Especificaciones Orden de Produccion Extrusion -->
                    <h4 align="center"><b>Especificaciones</b></h4>
                        <div class="col-md-3">
                            <h4 align="center"><input type="checkbox" class="chkplas" class="chkplas" id="chk15"  value="chk_ancho" name="chkRequisito[]" <?php if(in_array('chk_ancho', $Requisitos)){echo 'checked="checked"';}?> > Ancho (cms)</h4>
                              ...
                              <input type="text" name="ancho" class="form-control" value="<?php echo $datos['ancho'];?>">
                        </div>
                        <div class="col-md-3">
                            <h4 align="center"><input type="checkbox" class="chkplas" class="chkplas" id="chk16"  value="chk_calibre" name="chkRequisito[]" <?php if(in_array('chk_calibre', $Requisitos)){echo 'checked="checked"';}?> > Calibre (mp)</h4>
                                <div class="table-responsive"> 
                                    <table class="table table-bordered"> 
                                        <thead> 
                                            <tr> 
                                ...
                                <input type="text" name="calibre" class="form-control" value="<?php echo $datos['calibre'];?>">
                        </div>
                        <div class="col-md-3">
                            <h4 align="center"> <input type="checkbox" class="chkplas" class="chkplas" id="chk17"  value="chk_peso_m" name="chkRequisito[]" <?php if(in_array('chk_peso_m', $Requisitos)){echo 'checked="checked"';}?> 
                            >Peso Muestra (g)</h4>
                                <div class="table-responsive"> 
                                    <table class="table table-bordered"> 
                                        <thead> 
                                ...
                                <input type="text" name="peso_m" class="form-control" value="<?php echo $datos['peso_m'];?>">
                        </div>
                        <div class="col-md-3">
                                <div class="table-responsive"> 
