<?php 
$carpetaAdjunta="R:/laminacion_img/";
...
for($i = 0; $i < $Imagenes; $i++) {
	...
	$ImagenesSubidas[$i]="<img  height='120px'  src='ftp://192.168.2.8/NAS_Public/SCPBD/laminacion_img/$nombreArchivo' class='file-preview-image'>";
}
