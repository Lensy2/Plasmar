<?php 
  ...
  $registrosImpFilas = sqlsrv_query($connPlas, $comprobacionLam, array(), array( "Scrollable" => 'static' ));
  ...
  if ($contImpFilas != 0){
      ...
      echo    "<form method='post' action='http://".$_SERVER['SERVER_NAME']."/apps/laminacion/inconformidades/nueva_inconformidad.php'>
