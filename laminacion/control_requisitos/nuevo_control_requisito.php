      ...
      <div class="content-wrapper">
                ...
                <div class="table-responsive"> 
                    ...
                    <thead>
                      <tr>
                        <th>Laminacion N°</th>
                        <th>Fecha Entrega</th>
                        <th>Cliente<input type="checkbox" class="chkplas" class="minimal" value="chk_cliente" name="chklaminacion[]" ></th>
                        <th>NIT</th>
                        <th>Descripción<input type="checkbox" class="chkplas" class="minimal" value="chk_descripcion" name="chklaminacion[]" ></th>
                        <th>Codigo</th>
                      </tr>
                      </thead>
                      <tbody> 
           ...
           <h3 align="center">Ajuste De Maquina</h3>
            <br>
                        <div class="col-md-12">
                            <div class="table-responsive"> 
                                <table class="table table-bordered"> 
                                    <thead> 
                                        <tr> 
                                            <th>IMAGEN</th>
                                            <th>ANCHO<input type="checkbox" class="chkplas" class="minimal" value="chk_ancho" name="chklaminacion[]"></th> 
                                            <th>PASO<input type="checkbox" class="chkplas" class="minimal" value="chk_paso" name="chklaminacion[]"></th> 
                                            <th>SUSTRATO</th> 
                                            <th>MATERIAL</th> 
                                            <th>IMP ?</th> 
                                            <th>EXT ?</th> 
                          ...
                          <td><input type="checkbox" class="chkplas" class="minimal" value="chk_imp" name="chklaminacion[]"></td>
                          <td><input type="checkbox" class="chkplas" class="minimal" value="chk_ext" name="chklaminacion[]"></td> 
                          </tr>     
            ...
            <br>
                ...
                <tr>
                  <td> <?php $obsCal = "SELECT * FROM dbo.LAMINACION lam inner join  dbo.OBSCALIDAD cal on lam.NIT = cal.NIT where lam.NIT = '$fila->NIT' and proceso = 'LAMINACION' and lam.ORDENNRO = '$pedido'";
                       ...
                       <tr>
                        <th>OBSERVACIONES<input type="checkbox" class="chkplas" class="minimal" value="chk_observa" name="chklaminacion[]" ></th>
                        </tr>
                       <tbody> 
                          <tr> 
       ...
       <?php $plano = rutaPlano($fila->CODIGO);?>                  
            ...
            <div class="row">
              ...
              <input type="text" class="form-control" name="num_loteadca"> <br>
